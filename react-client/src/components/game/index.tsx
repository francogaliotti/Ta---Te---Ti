  ...
  const updateGameMatrix = (column: number, row: number, symbol: "x" | "o") => {
    ...
    if (socketService.socket) {
      ...
      if (currentPlayerWon && otherPlayerWon) {
        gameService.gameWin(socketService.socket, { lost: false, message: "Es un Empate" });
        Swal.fire('Es un Empate')
        restartGame()
      } else if (currentPlayerWon && !otherPlayerWon) {
        gameService.gameWin(socketService.socket, { lost: true, message: "Has Perdido" });
        Swal.fire('Ganaste la Partida!!')
        restartGame()
